...
/**
 * DTO for {@link com.pmq.vnnewsvoice.pojo.Reader}
 */
...
public class ReaderDto implements Serializable {
    ...
    public ReaderDto(Long id, Long userIdId, String userIdUsername, String userIdAvatarUrl, String userIdEmail, Date userIdBirthday, String userIdAddress, String userIdPhoneNumber, String userIdGender, Long userIdRoleIdId, String userIdRoleIdName, String userIdAvatarPublicId) {
        this.id = id;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userIdId, userIdUsername, userIdAvatarUrl, userIdEmail, userIdBirthday, userIdAddress, userIdPhoneNumber, userIdGender, userIdRoleIdId, userIdRoleIdName, userIdAvatarPublicId);
    }
